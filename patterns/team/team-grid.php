...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)">
	...
	<h2 class="wp-block-heading has-text-align-center" style="margin-bottom:var(--wp--preset--spacing--60)"><?php esc_html_e( 'Meet Our Team', 'krys' ); ?></h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column is-style-krys-card">
			...
			<h3 class="wp-block-heading has-text-align-center" style="margin-top:var(--wp--preset--spacing--40)"><?php esc_html_e( 'John Doe', 'krys' ); ?></h3>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"align":"center","textColor":"secondary"} -->
			<p class="has-text-align-center has-secondary-color has-text-color"><?php esc_html_e( 'CEO & Founder', 'krys' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column is-style-krys-card">
			...
			<!-- wp:heading {"textAlign":"center","level":3,"style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}}}} -->
			<h3 class="wp-block-heading has-text-align-center" style="margin-top:var(--wp--preset--spacing--40)"><?php esc_html_e( 'Jane Smith', 'krys' ); ?></h3>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"align":"center","textColor":"secondary"} -->
			<p class="has-text-align-center has-secondary-color has-text-color"><?php esc_html_e( 'Chief Technology Officer', 'krys' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column is-style-krys-card">
			...
			<!-- wp:heading {"textAlign":"center","level":3,"style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}}}} -->
			<h3 class="wp-block-heading has-text-align-center" style="margin-top:var(--wp--preset--spacing--40)"><?php esc_html_e( 'Mike Johnson', 'krys' ); ?></h3>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"align":"center","textColor":"secondary"} -->
			<p class="has-text-align-center has-secondary-color has-text-color"><?php esc_html_e( 'Head of Design', 'krys' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
	</div>
