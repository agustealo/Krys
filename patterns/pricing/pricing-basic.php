...
<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)">
	...
	<h2 class="wp-block-heading has-text-align-center" style="margin-bottom:var(--wp--preset--spacing--60)"><?php esc_html_e( 'Simple Pricing', 'krys' ); ?></h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column is-style-krys-card">
			...
			<h3 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Starter', 'krys' ); ?></h3>
			<!-- /wp:heading -->
			...
			<p class="has-text-align-center"><?php esc_html_e( 'per month', 'krys' ); ?></p>
			<!-- /wp:paragraph -->
			...
			<ul class="is-style-krys-checkmarks">
				<li><?php esc_html_e( '10 projects', 'krys' ); ?></li>
				<li><?php esc_html_e( '5GB storage', 'krys' ); ?></li>
				<li><?php esc_html_e( 'Email support', 'krys' ); ?></li>
			</ul>
			<!-- /wp:list -->
			...
			<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--40)">
				<!-- wp:button {"width":100} -->
				<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Get Started', 'krys' ); ?></a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
		</div>
		...
		<div class="wp-block-column is-style-krys-shadow">
			...
			<div class="wp-block-group has-base-color has-primary-background-color has-text-color has-background" style="border-radius:0.25rem;margin-bottom:var(--wp--preset--spacing--30);padding-top:0.5rem;padding-right:1rem;padding-bottom:0.5rem;padding-left:1rem">
				...
				<p class="has-text-align-center has-small-font-size"><?php esc_html_e( 'POPULAR', 'krys' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->

			<!-- wp:heading {"textAlign":"center","level":3} -->
			<h3 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Professional', 'krys' ); ?></h3>
			<!-- /wp:heading -->
			...
			<!-- wp:list {"className":"is-style-krys-checkmarks"} -->
			<ul class="is-style-krys-checkmarks">
				<li><?php esc_html_e( 'Unlimited projects', 'krys' ); ?></li>
				<li><?php esc_html_e( '100GB storage', 'krys' ); ?></li>
				<li><?php esc_html_e( 'Priority support', 'krys' ); ?></li>
				<li><?php esc_html_e( 'Advanced features', 'krys' ); ?></li>
			</ul>
			<!-- /wp:list -->
		...
		<div class="wp-block-column is-style-krys-card">
			<!-- wp:heading {"textAlign":"center","level":3} -->
			<h3 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'Enterprise', 'krys' ); ?></h3>
			<!-- /wp:heading -->
			...
			<!-- wp:list {"className":"is-style-krys-checkmarks"} -->
			<ul class="is-style-krys-checkmarks">
				<li><?php esc_html_e( 'Unlimited everything', 'krys' ); ?></li>
				<li><?php esc_html_e( 'Unlimited storage', 'krys' ); ?></li>
				<li><?php esc_html_e( '24/7 phone support', 'krys' ); ?></li>
				<li><?php esc_html_e( 'Custom integrations', 'krys' ); ?></li>
				<li><?php esc_html_e( 'Dedicated account manager', 'krys' ); ?></li>
			</ul>
			<!-- /wp:list -->
			...
			<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--40)">
				<!-- wp:button {"width":100} -->
				<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Contact Sales', 'krys' ); ?></a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
		</div>
