 ...
 * Slug: krys/testimonials-featured
...
<div class="wp-block-group alignfull has-gray-50-background-color has-background" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)">
	...
	<div class="wp-block-columns are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:40%">
			...
			<figure class="wp-block-image size-large has-custom-border"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/testimonial-featured.jpg" alt="<?php esc_attr_e( 'Client testimonial', 'krys' ); ?>" style="border-radius:0.5rem;aspect-ratio:1;object-fit:cover"/></figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:60%">
			...
			<p class="has-primary-color has-text-color has-small-font-size"><?php esc_html_e( 'SUCCESS STORY', 'krys' ); ?></p>
			<!-- /wp:paragraph -->

			<!-- wp:heading {"style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}}}} -->
			<h2 class="wp-block-heading" style="margin-top:var(--wp--preset--spacing--40)"><?php esc_html_e( 'How We Scaled to 10,000 Users', 'krys' ); ?></h2>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}}},"fontSize":"large"} -->
			<p class="has-large-font-size" style="margin-top:var(--wp--preset--spacing--40)"><?php esc_html_e( '"Working with this team has been game-changing. Their expertise and dedication helped us scale from 500 to 10,000 users in just 6 months. The platform is rock-solid and the ROI has exceeded all expectations."', 'krys' ); ?></p>
			<!-- /wp:paragraph -->
			...
			<div class="wp-block-group">
				...
				<figure class="wp-block-image size-thumbnail is-resized has-custom-border"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/testimonial-avatar-2.jpg" alt="<?php esc_attr_e( 'Client photo', 'krys' ); ?>" style="border-radius:100%;object-fit:cover;width:50px;height:50px"/></figure>
				<!-- /wp:image -->

				<!-- wp:group {"style":{"spacing":{"blockGap":"0.25rem"}},"layout":{"type":"flex","orientation":"vertical"}} -->
				<div class="wp-block-group">
					<!-- wp:paragraph -->
					<p><strong><?php esc_html_e( 'David Thompson', 'krys' ); ?></strong></p>
					<!-- /wp:paragraph -->

					<!-- wp:paragraph {"fontSize":"small","textColor":"secondary"} -->
					<p class="has-secondary-color has-text-color has-small-font-size"><?php esc_html_e( 'Founder & CEO, GrowthLabs', 'krys' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
