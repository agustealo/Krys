...
<div class="wp-block-group alignfull has-base-color has-primary-gradient-gradient-background has-text-color has-background" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)">
	...
	<p class="has-text-align-center has-small-font-size"><?php esc_html_e( 'TESTIMONIAL', 'krys' ); ?></p>
	<!-- /wp:paragraph -->

	<!-- wp:paragraph {"align":"center","fontSize":"x-large","style":{"spacing":{"margin":{"top":"var:preset|spacing|40"}}}} -->
	<p class="has-text-align-center has-x-large-font-size" style="margin-top:var(--wp--preset--spacing--40)"><?php esc_html_e( '"This solution transformed our business. We saw a 300% increase in productivity within the first month. The team is exceptional and the support is world-class."', 'krys' ); ?></p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--50)">
		...
		<figure class="wp-block-image size-thumbnail is-resized has-custom-border"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/testimonial-avatar.jpg" alt="<?php esc_attr_e( 'Client photo', 'krys' ); ?>" style="border-radius:100%;object-fit:cover;width:60px;height:60px"/></figure>
		<!-- /wp:image -->

		<!-- wp:group {"style":{"spacing":{"blockGap":"0.25rem"}},"layout":{"type":"flex","orientation":"vertical"}} -->
		<div class="wp-block-group">
			<!-- wp:paragraph {"fontSize":"medium"} -->
			<p class="has-medium-font-size"><strong><?php esc_html_e( 'Jennifer Martinez', 'krys' ); ?></strong></p>
			<!-- /wp:paragraph -->

			<!-- wp:paragraph {"fontSize":"small"} -->
			<p class="has-small-font-size"><?php esc_html_e( 'CEO, TechCorp Solutions', 'krys' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
	</div>
